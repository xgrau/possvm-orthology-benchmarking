...
# input
mid = read.table("results_evaluation/eval.ortb_all_mid_mcl.summary.csv", header = TRUE, stringsAsFactors = FALSE, sep = "\t", row.names = 1)
ite = read.table("results_evaluation/eval.ortb_all_ite_mcl.summary.csv", header = TRUE, stringsAsFactors = FALSE, sep = "\t", row.names = 1)
