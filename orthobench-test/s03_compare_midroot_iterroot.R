...
# input
mid = read.table("eval_o2o_raw_summary.csv",      header = TRUE, stringsAsFactors = FALSE, sep = "\t", row.names = 1)
ite = read.table("eval_o2o_iter_raw_summary.csv", header = TRUE, stringsAsFactors = FALSE, sep = "\t", row.names = 1)
...
pdf("difference_iter_mid.pdf", height = 5, width = 3)
