...
# input
ort_fo = "results_trees/permutations/"
...
pdf(sprintf("%s/eval_%s_all_permutations.pdf",out_fo,id),height = 5, width = 7)
layout(matrix(1:6, nrow = 2))


# precision
vioplot(dia_sum$precision ~ dia_sum$perm_fraction, xlab = "Fraction of mis-placed genes", ylab = "Precision", main="Mean precision",
        ylim=c(0.2,1), cex.axis=0.5, border="dodgerblue4", col="powderblue",rectCol="dodgerblue4", lineCol="dodgerblue4", pchMed=19, las=1)
abline(h=0.975, lty=2, col="red")
vioplot(dia_all$precision ~ dia_all$perm_fraction, xlab = "Fraction of mis-placed genes", ylab = "Precision", main="Per-gene precision",
        ylim=c(0,1), cex.axis=0.5, border="dodgerblue4", col="powderblue",rectCol="dodgerblue4", lineCol="dodgerblue4", pchMed=19, las=1)
abline(h=0.975, lty=2, col="red")

# recall
vioplot(dia_sum$recall ~ dia_sum$perm_fraction, xlab = "Fraction of mis-placed genes", ylab = "Recall", main="Mean recall", 
        ylim=c(0.2,1), cex.axis=0.5, border="dodgerblue4", col="powderblue",rectCol="dodgerblue4", lineCol="dodgerblue4", pchMed=19, las=1)
abline(h=0.936, lty=2, col="red")
vioplot(dia_all$recall ~ dia_all$perm_fraction, xlab = "Fraction of mis-placed genes", ylab = "Recall", main="Per-gene recall", 
        ylim=c(0,1), cex.axis=0.5, border="dodgerblue4", col="powderblue",rectCol="dodgerblue4", lineCol="dodgerblue4", pchMed=19, las=1)
abline(h=0.936, lty=2, col="red")

# fscore
vioplot(dia_sum$Fscore ~ dia_sum$perm_fraction, xlab = "Fraction of mis-placed genes", ylab = "F1", main="Mean F1 score", 
        ylim=c(0.2,1), cex.axis=0.5, border="dodgerblue4", col="powderblue",rectCol="dodgerblue4", lineCol="dodgerblue4", pchMed=19, las=1)
abline(h=0.941, lty=2, col="red")
vioplot(dia_all$Fscore ~ dia_all$perm_fraction, xlab = "Fraction of mis-placed genes", ylab = "F1", main="Per-gene F1 score", 
        ylim=c(0,1), cex.axis=0.5, border="dodgerblue4", col="powderblue",rectCol="dodgerblue4", lineCol="dodgerblue4", pchMed=19, las=1)
abline(h=0.941, lty=2, col="red")
dev.off()
