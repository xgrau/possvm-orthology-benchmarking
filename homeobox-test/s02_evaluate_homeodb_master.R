...
set_list = list(
  ...
  # list(id = "antp_all_ite_kcl",  ref = "results_searches/ANTP.seed.diamond-edit.csv", ort_fn = "results_trees/ANTP.possom_kcl.ortholog_groups.csv",  sps_list = c("Drer","Galgal","Hsap","Mmus","Xentro","Dmel","Apimel","Tcas","Bflo")),
  list(id = "antp_all_ite_spst", ref = "results_searches/ANTP.seed.diamond-edit.csv", ort_fn = "results_trees/ANTP.possom_spst.ortholog_groups.csv", sps_list = c("Drer","Galgal","Hsap","Mmus","Xentro","Dmel","Apimel","Tcas","Bflo")),
  ...
  list(id = "tale_nocni_ite_mcl",ref = "results_searches/ANTP.seed.diamond-edit.csv", ort_fn = "results_trees/ANTP.possom_nocni.ortholog_groups.csv",sps_list = c("Drer","Galgal","Hsap","Mmus","Xentro","Dmel","Apimel","Tcas","Bflo"))
)
